...
$(document).ready( () => {
    ...
    // handle submit on Join List button
    $("#join_list").click( evt=> {
        let isValid = true;
        console.trace();
